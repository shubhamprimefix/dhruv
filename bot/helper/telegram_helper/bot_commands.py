...
class _BotCommands:
    def __init__(self):
        ...
        self.DeleteCommand = f'delete{CMD_PERFIX}'
        ...
        self.AuthorizeCommand = f'allow{CMD_PERFIX}'
        self.UnAuthorizeCommand = f'block{CMD_PERFIX}'
        ...
        self.LogCommand = f'logs{CMD_PERFIX}'
